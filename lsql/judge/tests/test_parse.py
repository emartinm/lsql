...
from judge.parse import get_language_from_json, get_problem_type_from_zip
from judge.tests.test_common import TestPaths, create_collection
...
class ParseTest(TestCase):
    ...
    def test_zip_errors(self):
        ...
        # Select problems
        for filename in [
            TestPaths.SELECT_MISSING_FILES,
            TestPaths.SELECT_EMPTY_TITLE,
            TestPaths.SELECT_TEXT_DECODE,
        ]:
        ...
        # DML problems
        for filename in [
            TestPaths.DML_MISSING_FILES,
            TestPaths.DML_BAD_NUM_STMT,
            TestPaths.DML_TEXT_DECODE,
        ]:
            zip_path = os.path.join(curr_path, TestPaths.ZIP_FOLDER, filename)
        ...
        # Function problems
        for filename in [
            TestPaths.FUNCTION_MISSING_FILES,
            TestPaths.FUNCTION_EMPTY_TITLE,
        ...
        # Procedure problems
        for filename in [
            TestPaths.PROC_MISSING_FILES,
            TestPaths.PROC_EMPTY_TITLE,
            TestPaths.PROC_TEXT_DECODE,
        ]:
            zip_path = os.path.join(curr_path, TestPaths.ZIP_FOLDER, filename)
        ...
        # Trigger problems
        for filename in [
            TestPaths.TRIGGER_MISSING_FILES,
            TestPaths.TRIGGER_EMPTY_TITLE,
            TestPaths.TRIGGER_TEXT_DECODE,
        ...
        for filename in [
            TestPaths.DISCRIMINANT_MISSING_FILES,
            TestPaths.DISCRIMINANT_BAD_STMT,
