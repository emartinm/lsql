...
class LanguagesTest(TestCase):
    ...
    def test_password_change_language(self):
        ...
        self.assertIn(
            "Your password can not be similar to your personal information",
    ...
    def test_feedback_language(self):
        ...
        self.assertIn(
            "Generated by your SQL code: 3 columns",
        ...
        self.assertIn(
            "Generated name by your SQL code: name",
        ...
        self.assertIn(
            "Nombre generado por tu código SQL: name",
            compare_select_results(expected, obtained1, False)[1],
        )
    ...
    def test_ranking_language(self):
        ...
        self.assertIn("Solved", response.content.decode("utf-8"))
        self.assertIn(
            "Sum of the first accepted submission of each exercise",
            response.content.decode("utf-8"),
        )
