...
urlpatterns = [
    ...
    path("hint/<int:problem_id>", views.get_hint, name="hint"),
    ...
    path(
        "submission/<int:submission_id>/download_submission",
        views.download_submission,
        name="download_submission",
    ),
    path("ranking/", views.show_results, name="results"),
    path("ranking/<int:collection_id>", views.show_result, name="result"),
    path("ranking/<int:collection_id>/download", views.download_ranking, name="download_ranking"),
    path("achievements/<int:user_id>", views.show_achievements, name="achievements"),
    path("hints/", views.show_hints, name="hints"),
