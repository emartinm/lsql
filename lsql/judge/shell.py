...
def extended_submissions(filename: str) -> None:  # pragma: no cover
...
def user_submissions_per_type(user) -> dict: # pragma: no cover
...
def submissions_per_user(filename: str) -> None:  # pragma: no cover
